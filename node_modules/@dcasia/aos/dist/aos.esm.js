 ...
 * @return {void}
 */
var handleScroll = function handleScroll($elements, event) {
...
var prepare = function prepare($elements, options) {
  $elements.forEach(function (el, i) {
    ...
    if (disableAnimation && !el.hasDisabled) {
      disable(el, options);
      el.hasDisabled = true;
    }
...
var currentScrollHandler = void 0;
var initializeScroll = function initializeScroll() {
   ...
   */
  var eventName = options.customScrollEvent || 'scroll';
  if (currentScrollHandler) {
    window.removeEventListener(eventName, currentScrollHandler);
  }
  currentScrollHandler = throttle(function (event) {
